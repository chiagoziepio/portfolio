  ...
  return (
    <section className='hero' id='home'>
        <div className='heroUpperPart'>
            <h3>Hi am <span className='name'>CHRISTOPHER</span><br /> A deligient and dedicated <span className='category'>Frontend developer</span></h3>
            <p>download Resume</p>
        </div>
